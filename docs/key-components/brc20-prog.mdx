...
| Feature | BRC2.0 | Alkanes |
|---------|--------|---------|
| **Encoding** | JSON inscriptions | Binary (BIN protocol) |
| **Language** | Solidity/EVM | Rust |
| **Indexer** | Standard ord | Alkanes-specific |
| **State Model** | EVM accounts | UTXO-based |
| **Best For** | General computation | Token operations |

### Interoperability

BRC2.0 and Alkanes can interoperate:

- BRC2.0 contracts can trigger Alkanes operations
- Alkanes contracts can hold assets managed by BRC2.0
- The `wrapAndExecute2` pattern enables atomic cross-protocol calls
...
- [BRC2.0 Developer Guide](../developer-guide/brc20-prog) — How to deploy and call contracts
- [Alkanes Metaprotocol](./alkanes) — Token-focused operations
- [Schnorr Signatures](./schnorr-signatures) — Underlying cryptography
