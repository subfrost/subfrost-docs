...
Through its roles in governance, value accrual, and security, the `FROST` token is an integral part of the SUBFROST protocol, ensuring its sustainability and growth. Learn more on the FROST token [**page.**](../tokens/FROST-token.mdx)