...
## `frBTC` Smart Contract in Subfrost
...
This command will create a Bitcoin transaction that calls the `wrap` method of the `frBTC` smart contract and sends 1.0 BTC to the FROST-controlled multisig wallet.
