...
# `dxBTC` Overview
## The Yield-bearing BTC of Bitcoin L1
...
*   **Providing liquidity to decentralized exchanges:** The `frBTC` can be used to provide liquidity to delta-neurtral LPs like `frBTC`/`BTC` or other trading pairs on decentralized exchanges, earning trading fees.
