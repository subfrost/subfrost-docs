...
- Cross-chain support for USDT, SOL, ZEC, USDC, USDT
...
Liquidity providers earn fees from trades in their pool. Note: For BTC pools, user BTC is atomically wrapped to frBTC.
