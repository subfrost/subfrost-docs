...
- **Staking:** The stake is expected to be a combination of BTC in the form of frBTC, and the [FUEL token](/tokens/FROST-token), creating a powerful incentive for honest participation. Learn more about staking on the SUBFROST's Proof-of-Stake page [**here.**](/key-components/proof-of-stake)
