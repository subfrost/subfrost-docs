...
We are already live on **BRC2.0** (BRC20) Signet, and building is underway on the **Arch Network** via the Titan Indexer.
...
- **Staking:** The stake is expected to be a combination of BTC in the form of frBTC, and the [FROST token](/tokens/FROST-token), creating a powerful incentive for honest participation. Learn more about staking on the SUBFROST's Proof-of-Stake page [**here.**](/key-components/proof-of-stake)
