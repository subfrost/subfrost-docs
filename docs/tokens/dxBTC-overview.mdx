...
*   **Providing liquidity to decentralized exchanges:** The `frBTC` can be used to provide liquidity to delta-neutral LPs like `frBTC`/`BTC` or other trading pairs on decentralized exchanges, earning trading fees.
...
**<a href="/key-components/proof-of-stake">SUBFROST governance</a>** plays a crucial role in `dxBTC`. The governance is responsible for:
