...
Even better, teams are already collaborating to integrate the `frBTC` wrap contract into the start of their transactions. The OYL AMM is a great example of this, now delivering one of the best user experiences in Bitcoin.
