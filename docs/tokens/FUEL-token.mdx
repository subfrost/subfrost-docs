...
:::note[FUEL is not a gas token]
This page is about `FUEL`, the governance token. It is unrelated to lowercase **fuel**, the compute budget an Alkanes contract call may spend. You never buy or spend `FUEL` to transact: fuel is free, and network fees are the ordinary Bitcoin miner fee, paid in native BTC. See [Alkanes](../protocol/alkanes).
:::
