...
All protocol fees are used to buy & burn `FROST`, SUBFROST's protocol token, driving value to holders by increasing demand and decreasing supply.
...
`FROST` is also an integral componant of the [SUBFROST Proof-of-Stake](./proof-of-stake.mdx).
