...
This model is **already proven** on other blockchains like Ethereum and Solana and can be dramatically simplified for the end user. SUBFROST will enable users to earn yield on their **native BTC** in the **simplest** & **most-secure** way possible.
