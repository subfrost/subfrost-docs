...
The heart of a `subp2p` node is the `SubfrostNetworkBehaviour`. This is a composite `libp2p` `NetworkBehaviour` that combines all the different protocols and behaviours used by Subfrost:
