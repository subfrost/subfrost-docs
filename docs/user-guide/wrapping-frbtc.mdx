...
This is achieved through a trust-minimized process that locks BTC on the Bitcoin mainnet and mints a corresponding amount of `frBTC` on the SUBFROST protocol. This frBTC can then be used across the Alkanes, BRC-20 2.0 and OP_NET ecosystems.
