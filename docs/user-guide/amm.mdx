...
The `subrail-cli` integrates with Rebar Labs Shield to provide private transaction broadcasting. This is useful for protecting your privacy when interacting with the AMM.
