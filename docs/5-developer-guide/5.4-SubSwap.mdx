...
The `subrail-cli` integrates with Rebar Labs' Shield product to provide private transaction broadcasting. This is useful for protecting your privacy when interacting with the AMM. For more informayion on Rebar Labs, please visit https://rebarlabs.io.
